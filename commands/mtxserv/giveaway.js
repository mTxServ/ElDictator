...
module.exports = class GiveawayCommand extends mTxServCommand {
    ...
    async run(msg) {
        ...
        const actions = [
            ...
            //'🔟 points - rejoindre un discord partenaire: [GCA](https://discord.com/oauth2/authorize?client_id=535435520394657794&permissions=604892353&scope=bot) ou [Numerix](https://discord.com/oauth2/authorize?client_id=535435520394657794&permissions=604892353&scope=bot)',
